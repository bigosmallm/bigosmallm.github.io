/**
 * Generated by Apache Flex Cross-Compiler from org/apache/flex/binding/MXMLBeadViewBaseDataBinding.as
 * org.apache.flex.binding.MXMLBeadViewBaseDataBinding
 *
 * @fileoverview
 *
...
goog.provide('org.apache.flex.binding.MXMLBeadViewBaseDataBinding');
 ...
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding = function() {
  
  this.deferredBindings = {};
  org.apache.flex.binding.MXMLBeadViewBaseDataBinding.base(this, 'constructor');
};
goog.inherits(org.apache.flex.binding.MXMLBeadViewBaseDataBinding, org.apache.flex.core.DataBindingBase);
 ...
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype._strand;
 ...
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype.initCompleteHandler = function(event) {
    ...
    if (org.apache.flex.utils.Language.is(binding.source, Array)) {
      if (binding.source[0] in this._strand) {
        if (binding.source.length == 2 && binding.destination.length == 2) {
          ...
          var /** @type {Object} */ modelWatcher = watchers.watcherMap[binding.source[0]];
 ...
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype.makeGenericBinding = function(binding, index, watchers) {
 ...
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype.setupWatchers = function(gb, index, watchers, parentWatcher) {
 ...
 * @return {Object}
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype.decodeWatcher = function(bindingData) {
 ...
 * @type {Object}
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype.deferredBindings;
 ...
 * @param {org.apache.flex.events.Event} event
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype.deferredBindingsHandler = function(event) {
...
Object.defineProperties(org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype, /** @lends {org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype} */ {
/** @export */
strand: {
set: /** @this {org.apache.flex.binding.MXMLBeadViewBaseDataBinding} */ function(value) {
  this._strand = value;
 ...
 */
org.apache.flex.binding.MXMLBeadViewBaseDataBinding.prototype.FLEXJS_CLASS_INFO = { names: [{ name: 'MXMLBeadViewBaseDataBinding', qName: 'org.apache.flex.binding.MXMLBeadViewBaseDataBinding'}], interfaces: [org.apache.flex.core.IBead] };
